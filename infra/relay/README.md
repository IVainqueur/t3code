...
> [!NOTE]
> Sign in to T4 Connect from the app under Settings > Connections.
...
See the [T4 Connect architecture note](../../docs/internals/t3-connect.md) for the larger system
design.
...
- [T4 Connect setup](../../docs/operations/connect-setup.md) for Clerk keys, JWT templates, and sign-up restrictions.
- [Relay Observability](../../docs/operations/relay-observability.md) for deployment tracing and diagnostics.
- [T4 Connect architecture](../../docs/internals/t3-connect.md) for environment linking and trust boundaries.
