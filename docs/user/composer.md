...
also send files to T4 Code through another app's system share sheet.
...
messages survive app restarts. Signing out of T4 Connect keeps that work on your
...
T4 Code remembers your provider, model, and model options for new threads. A
...
Transcription runs on your device. T4 Code deletes the temporary audio after
...
Provider commands must start the message to run. T4 Code commands such as
...
complete T4 Code tells you and leaves the chip for you to remove or replace. A chip whose
...
automatically. HTML previews cannot access your T4 Code session.
