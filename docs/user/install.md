...
T4 Code runs coding agents on your computer and lets you control them from its
...
launch T4 Code and configure providers afterwards.
...
there. Install Node.js and provider CLIs inside that distro. T4 Code installs its
...
[remote access](./remote-access.md) to link it through T4 Connect or a pairing URL.
