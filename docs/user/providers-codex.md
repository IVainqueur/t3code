...
Both instances must use the same **CODEX_HOME path**. T4 Code prepares the shared
...
Choose the other account from the thread's model picker. T4 Code offers compatible
