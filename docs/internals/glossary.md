...
Terms whose meaning matters across T4 Code. Architecture and lifecycle constraints belong in the
...
| Term                | Meaning                                                                                                      |
| ------------------- | ------------------------------------------------------------------------------------------------------------ |
| Provider            | The agent runtime T4 Code controls, such as Codex or Claude Code.                                            |
...
| Adapter             | The boundary translating a provider's native protocol into T4 Code operations and events.                    |
