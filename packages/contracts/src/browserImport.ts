 ...
 * machine into a T4 Code browser profile.
 *
...
export const BrowserImportInput = Schema.Struct({
  ...
  /** T4 Code profile the cookies are written into. */
...
const BROWSER_IMPORT_UNAVAILABLE_COPY: Readonly<Record<BrowserImportUnavailableReason, string>> = {
  ...
  needsFullDiskAccess:
    "Give T4 Code Full Disk Access in System Settings → Privacy & Security, then retry.",
