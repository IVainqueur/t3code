...
const GNOME_ACCESS_COPY = {
  "not-installed": {
    ...
    description:
      "The T4 Code GNOME extension lets you capture other windows and bring them into your draft. Sign out once after installing.",
  },
  "restart-required": {
  ...
  disabled: {
    ...
    description: "Enable T4 Code SnapShots to start capturing windows.",
  },
  enabled: {
  ...
  error: {
    ...
    description: "Check T4 Code SnapShots in GNOME Extensions, then try again.",
  },
};
              ...
              : {
                  title:
                    helper?.status === "update-required"
                      ...
                      : "Allow snapshots",
                  description:
                    "T4 Code's capture helper lets you capture other apps and return to your draft. It's included with T4 Code.",
                }
          : backend === "niri"
            ? {
                title: "Capture is ready",
              ...
              <details className="text-xs text-muted-foreground">
                ...
                <div className="mt-3 space-y-3">
                  ...
                  {step === "access" && (backend === "gnome" || helperBackend) ? (
                    <p>Included with T4 Code. No download needed.</p>
                  ) : null}
