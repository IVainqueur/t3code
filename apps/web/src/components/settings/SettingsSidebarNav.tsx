...
const T4ConnectSidebarSignIn = lazy(() =>
  import("../clerk/T4ConnectSidebarSignIn").then((module) => ({
    default: module.T4ConnectSidebarSignIn,
  })),
);
const T4ConnectSidebarAvatar = lazy(() =>
  import("../clerk/T4ConnectSidebarSignIn").then((module) => ({
    default: module.T4ConnectSidebarAvatar,
  })),
);
