...
/**
 * The palette T4 Code wears with no theme installed, captured from the app's
...
/**
 * The standard T4 Code look as a theme palette, for seeding a new theme when
...
/**
 * The status colors T4 Code shows without a theme, read from the app's own
